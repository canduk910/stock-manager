...
| **매매** ▼ | 주문(국내/해외/FNO, 실시간 호가창, **2026-05-08 KRX+NXT+SOR 통합** — 거래소 셀렉터 + 시간대 자동 분기, **2026-05-08~09 해외매매화면 풀패키지 개선** — 미국 10단계 호가창(KIS WS 우선 + REST 폴백) + 현재가 상세(시/고/저/거래량/52주) + USD/KRW 환율 동시 표시 + ET 기반 미국 거래시간 라벨(프리/정규/애프터/휴장+공휴일 30일)) / 잔고 조회 / 양도세(FIFO 자동 계산+시뮬레이션) |

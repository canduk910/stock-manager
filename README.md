...
- **증권사 컨센서스 통합**: 네이버 증권 리서치 PDF 본문을 GPT-4o-mini로 6항목(catalyst/risk/TP 근거/EPS 변경) 요약 → AI 프롬프트에 합류. 중앙 목표가·dispersion·momentum 5단계·과열 경고·6개월 추이. 체제별 차등(defensive 미표시 / cautious 50% 감산). US는 yfinance 등급 변경 이력. 시스템 호출 모드(유저 일일 쿼터 미차감)

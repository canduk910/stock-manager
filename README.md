...
| **분석** ▼ | 매크로 분석(11섹션: 경기국면·지수·**투자자별 수급(코스피/코스닥, 개인/외국인/기관 일별+누적)**·심리·금리차·신용스프레드(HY OAS 백분위 5단계 하워드 막스 시계추 + IG OAS·HY-IG 보조)·환율·원자재·섹터히트맵·**뉴스(4h 공유 캐시)**·**투자자(KST 일별 공유 캐시)**) / 종목 스크리너(섹터·52주 하락률 필터 포함) / 공시 조회. **2026-05-12 pre-warm** — KST 00:05 cron으로 매크로 GPT 자동 적재 (자정 후 첫 사용자 즉시 응답) |

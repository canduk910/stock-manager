...
| **관심종목** | 종목 자동완성 검색 추가. 시세·재무·섹터 대시보드. 종목 상세(재무 10년/4년·밸류에이션·종합 리포트). |
| **분석** ▼ | 매크로 분석(11섹션: 경기국면·지수·**투자자별 수급(코스피/코스닥, 개인/외국인/기관 일별+누적)**·심리·금리차·신용스프레드(HY OAS 백분위 5단계 하워드 막스 시계추 + IG OAS·HY-IG 보조)·환율·원자재·섹터히트맵·뉴스·투자자) / 종목 스크리너(섹터·52주 하락률 필터 포함) / 공시 조회 |

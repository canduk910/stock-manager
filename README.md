...
| **관심종목** | 종목 자동완성 검색 추가. 시세·재무·섹터 대시보드. 종목 상세(재무 10년/4년·밸류에이션·종합 리포트). **2026-05-12 N+1 해소** — `/api/watchlist/batch-details` + `/api/detail/{code}/bundle` ThreadPool 병렬, 대시보드 10~20s → 2~5s. |

...
class WatchlistRepository:
    ...
    def get_item(self, code: str, market: str = "KR") -> Optional[dict]:
        row = (
            self.db.query(Watchlist)
    ...
    def add_item(self, code: str, name: str, memo: str = "", market: str = "KR") -> bool:
    ...
    def update_memo(self, code: str, memo: str, market: str = "KR") -> bool:
        count = (
            self.db.query(Watchlist)
            .filter_by(code=code, market=market)
            .update({"memo": memo})
    ...
    def save_order(self, items: list[dict]) -> None:
        self.db.query(WatchlistOrder).delete()
        self.db.add_all([
            WatchlistOrder(code=it["code"], market=it["market"], position=i)

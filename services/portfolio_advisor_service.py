...
def _build_system_prompt(regime: str, cash_pct: float, cycle_ctx: dict | None = None) -> str:
...
{_format_cycle_context(cycle_ctx)}"""
...
def _build_prompt(context: dict, macro_ctx: dict, regime: str, regime_desc: str) -> tuple[str, str]:
    ...
    system_prompt = _build_system_prompt(regime, cash_ratio, cycle_ctx)
